const Apprenticeships = () => {
    return (
        <main className="apprenticeships--container">
            ...
            <img className="apprenticeships--img" src="https://cdn-resources.ableton.com/resources/filer_thumbnails/unsorted-uploads/azubi_photos_3_1.jpg__920.0x613.0_q85_subsampling-2.jpg" alt=""/>
            ...
            <p className="apprenticeships--p">If this sounds like you, feel free to have a look at our detailed information in German <a href="">here</a>. And please share this page with anyone who might be interested to help us find our future colleagues!</p>
            <img className="apprenticeships--img" src="https://cdn-resources.ableton.com/resources/filer_thumbnails/unsorted-uploads/azubi_photos_3_2.jpg__920.0x613.0_q85_subsampling-2.jpg" alt=""/>
        </main>
    )
}
